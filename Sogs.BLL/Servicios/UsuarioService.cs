    ...
    public class UsuarioService : IUsuarioService
    {
        ...
        public async Task<bool> Editar(UsuarioDTO modelo)
        {
            try
            {
                ...
                usuarioEncontrado.IdTipoDocumento = usuarioModelo.IdTipoDocumento;
                usuarioEncontrado.NumeroDocumento = usuarioModelo.NumeroDocumento;
                usuarioEncontrado.PrimerNombre = usuarioModelo.PrimerNombre;
                usuarioEncontrado.SegundoNombre = usuarioModelo.SegundoNombre;
                usuarioEncontrado.PrimerApellido = usuarioModelo.PrimerApellido;
                usuarioEncontrado.SegundoApellido = usuarioModelo.SegundoApellido;
